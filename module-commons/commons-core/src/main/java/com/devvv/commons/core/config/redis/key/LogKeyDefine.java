 ...
 */
@Getter
public enum LogKeyDefine implements KeyDefine {
    ;
    ...
    LogKeyDefine(KeyMode keyMode, DataMode dataType, Integer seconds) {
    ...
    LogKeyDefine(KeyMode keyMode, DataMode dataType, TTLMode mode) {
        this.keyMode = keyMode;
        this.dataType = dataType;
        this.ttlMode = mode;
        this.seconds = null;
